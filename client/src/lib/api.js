...
export const addPartial = (id, param) => axios.patch(`${real}/api/documentindexes/${id}/add`, { ...param });
...
export const deleteVendorLetter = (id, param) =>
	axios.patch(`${real}/api/vendorletters/${id}/delete`, { ...param });
export const inOutVendorLetter = (id, param) => axios.patch(`${real}/api/vendorletters/${id}/inout`, { ...param });
export const deleteInOutVendorLetter = (id, param) => axios.patch(`${real}/api/vendorletters/${id}/inout/delete`, { ...param });
...
export const replyLetter = (id, param) => axios.patch(`${real}/api/letters/${id}/reply`, { ...param });
export const cancelLetter = (id, param) => axios.patch(`${real}/api/letters/${id}/cancel`, { ...param });
...
export const deleteProject = (id, param) => axios.patch(`${real}/api/projects/${id}/delete`, { ...param });
